...
class SetChatAvailableReactions(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        reactions_limit (``int`` ``32-bit``, *optional*):
            This flag may be used to impose a custom limit of unique reactions (i.e. a customizable version of appConfig.reactions_uniq_max); this field and the other info set by the method will then be available to users in channelFull and chatFull.

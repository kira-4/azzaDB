...
class StarsStatus(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        subscriptions_next_offset (``str``, *optional*):
            Offset for pagination of subscriptions: only usable with payments.getStarsSubscriptions, returned when invoking payments.getStarsTransactions and payments.getStarsSubscriptions.

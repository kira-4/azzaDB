...
class InvitedUsers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~hydrogram.raw.base.messages.InvitedUsers`.
    ...
    Parameters:
        updates (:obj:`Updates <hydrogram.raw.base.Updates>`):
            List of updates about successfully invited users (and eventually info about the created group)

        missing_invitees (List of :obj:`MissingInvitee <hydrogram.raw.base.MissingInvitee>`):
